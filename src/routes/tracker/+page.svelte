...
<div class="flex justify-between p-2">
	<h2 class="text-2xl mb-5">Report tasks</h2>
	<div class="flex gap-2">
		<input class="input input-sm input-bordered" placeholder="team" />
		<input class="input input-sm input-bordered" placeholder="project" />
	</div>
</div>
<Task />
<button
